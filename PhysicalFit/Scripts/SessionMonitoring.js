$(document).ready(function () {
    // 初始化時隱藏所有監控項目
    $('#session_RPE, #arrow_Training, #shotting_Training, #Detection_Sys, #RPEtable, #btnModal, #btn_result, #btn_save, #btnRecord, #sessionRPEresult').hide();
        ...
        $('#Item').change(function () {
            ...
            // 隱藏所有項目
            $('#session_RPE, #arrow_Training, #shotting_Training, #Detection_Sys, #RPEtable, #btnModal, #btn_result, #btn_save, #btnRecord').hide();
            ...
            if (selectItem === '一般訓練衝量監控 (session-RPE)') {
                ...
                $('#Detection_Sys, #RPEtable, #btnModal').show();
