...
namespace PhysicalFit.Models
{
    ...
    public partial class RollerSkiingRecord
    {
        public int ID { get; set; }
        public Nullable<int> DetectionRecordID { get; set; }
        public string Distance200 { get; set; }
        public string Distance500 { get; set; }
        public string Distance1000 { get; set; }
        public string Distance2000 { get; set; }
        public Nullable<double> TimeExhaustion { get; set; }
