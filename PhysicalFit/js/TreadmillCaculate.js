...
function calculateSpeed(input) {
    ...
    var intensity = parseFloat(input.getAttribute("data-distance"));
    ...
    document.getElementById("CriticalSpeed").value = TreadmillLimitSpeed;

    TreadmillMaxWork = formatFiveDigits(TreadMillMaxR_a);
    document.getElementById("AnaerobicPower").value = TreadmillMaxWork;


    document.getElementById("calculationResult").value = TreadMillMaxR = Math.round(MaxR * 10000) / 10000;
}
